    ...
    return (
        <section className="flex flex-col justify-center items-center text-left mt-12 w-full antialiased">
            ...
            <div className='flex flex-col items-start max-w-7xl px-4 py-28 terms-privacy:py-10'>
                ...
                <p>
                    A sua privacidade é importante para nós. É política do site TIPTV respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <Link href="https://xtstream.com.br" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">TIPTV</Link>, e outros sites que possuímos e operamos.
                </p>
                ...
                <p>
                    Nossa política é atualizada de forma constante. O titular de dados está ciente de que o conteúdo desta Política de Privacidade pode ser alterado a critério do site TIPTV, independentemente de aviso ou notificação. Em caso de alteração, as modificações produzem todos os efeitos a partir do momento da disponibilização no site.
                </p>

                <p>
                    O site TIPTV não se responsabiliza caso você venha a utilizar seus dados de forma incorreta ou inverídica, ficando excluído de qualquer responsabilidade neste sentido.
                </p>

                <h2 className="text-xl font-bold mt-6 mb-4">Política de Cookies</h2>

                <h3 className="text-lg font-semibold mt-4">O que são cookies?</h3>
                <p>
                    Como é prática comum em quase todos os sites profissionais, este site usa cookies, que são pequenos arquivos baixados no seu computador, para melhorar sua experiência. Esta página descreve quais informações eles coletam, como as usamos e por que às vezes precisamos armazenar esses cookies. Também compartilharemos como você pode impedir que esses cookies sejam armazenados, no entanto, isso pode fazer o downgrade ou &quot;quebrar&quot; certos elementos da funcionalidade do site.
                </p>

                <h3 className="text-lg font-semibold mt-4">Como usamos os cookies?</h3>
                <p>
                    Utilizamos cookies por vários motivos, detalhados abaixo. Infelizmente, na maioria dos casos, não existem opções padrão do setor para desativar os cookies sem desativar completamente a funcionalidade e os recursos que eles adicionam a este site. É recomendável que você deixe todos os cookies se não tiver certeza se precisa ou não deles, caso sejam usados ​​para fornecer um serviço que você usa.
                </p>

                <h3 className="text-lg font-semibold mt-4">Desativar cookies</h3>
                <p>
                    Você pode impedir a configuração de cookies ajustando as configurações do seu navegador (consulte a Ajuda do navegador para saber como fazer isso). Esteja ciente de que a desativação de cookies afetará a funcionalidade deste e de muitos outros sites que você visita. A desativação de cookies geralmente resultará na desativação de determinadas funcionalidades e recursos deste site. Portanto, é recomendável que você não desative os cookies.
                </p>

                <h3 className="text-lg font-semibold mt-4">Cookies que definimos</h3>
                <ul className="list-disc list-inside">
                    ...
                    <li><strong>Cookies relacionados a pesquisas:</strong> Oferecemos pesquisas e questionários para fornecer informações interessantes, ferramentas úteis ou para entender nossa base de usuários com mais precisão.</li>
                    <li><strong>Cookies relacionados a formulários:</strong> Quando você envia dados por meio de um formulário, os cookies podem ser configurados para lembrar os detalhes do usuário para correspondência futura.</li>
                    <li><strong>Cookies de preferências do site:</strong> Para proporcionar uma ótima experiência, definimos cookies para lembrar suas preferências.</li>
                </ul>

                <h3 className="text-lg font-semibold mt-4">Cookies de Terceiros</h3>
                <p>
                    Em alguns casos especiais, também usamos cookies fornecidos por terceiros confiáveis. A seção a seguir detalha quais cookies de terceiros você pode encontrar através deste site.
                </p>
                <ul className="list-disc list-inside">
                    <li>Este site usa o Google Analytics, que é uma das soluções de análise mais difundidas e confiáveis ​​da Web.</li>
                    <li>As análises de terceiros são usadas para rastrear e medir o uso deste site.</li>
                    <li>Periodicamente, testamos novos recursos e fazemos alterações sutis na maneira como o site se apresenta.</li>
                    <li>À medida que vendemos produtos, é importante entendermos as estatísticas sobre quantos visitantes de nosso site compram.</li>
                </ul>

                <h3 className="text-lg font-semibold mt-4">Compromisso do Usuário</h3>
                <ul className="list-disc list-inside">
                    <li>Não se envolver em atividades ilegais ou contrárias à boa fé e à ordem pública.</li>
                    <li>Respeitar todas as legislações nacionais ou internacionais em que o Brasil é signatário.</li>
                    <li>Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou contra os direitos humanos.</li>
                    <li>Não causar danos aos sistemas físicos e lógicos do site XT Stream, de seus fornecedores ou terceiros.</li>
                    <li>Os conteúdos publicados possuem direitos autorais e de propriedade intelectual reservados.</li>
                </ul>

                <h2 className="text-xl font-bold mt-6 mb-4">Direitos do titular de dados</h2>
                <p>
                    O titular de dados pessoais possui o direito de solicitar do site TIPTV, através do canal específico de tratamento, informações referentes aos seus dados.
                </p>
                <p>
                ...
                <p className="mt-6">
                    Esta política é eficaz a partir de <strong>01 de janeiro de 2024.</strong>
                </p>
            </div>
        </section>
    );
